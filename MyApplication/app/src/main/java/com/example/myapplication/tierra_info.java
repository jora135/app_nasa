...
public class tierra_info extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tierra_info);
        ...
        icon_nasa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(tierra_info.this, MainActivity.class);
                startActivity(i);
            }
        });
        //========================ir a home=========================================
        ...
        icon_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(tierra_info.this, tierra_info.class);
                startActivity(i);
            }
        });
        //========================ir a satelite=========================================
        ...
        icon_gps.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(tierra_info.this, satelite_info.class);
                startActivity(i);
            }
        });
        //========================ir a list=========================================
        ...
        icon_list.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(tierra_info.this, list_info.class);
                startActivity(i);
            }
        });
